...
const Home = () => {
  ...
  const { search, moviesData, favorites, setFavorities } = useContext(myContext);
                ...
                <div key={movie.imdbID} className="group relative">
                  ...
                  <Link to={`/movies/${movie.imdbID}`}>
                    <div className="relative rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.8)] hover:shadow-[0_30px_80px_rgba(255,0,0,0.18)] transition-shadow duration-300 transform-gpu hover:translate-y-[-4px]">
                      <img
                        src={movie.Poster !== "N/A" ? movie.Poster : "https://i.ibb.co/jzypJPW/cinema-seats-placeholder.jpg"}
                        alt={movie.Title}
                  ...
                  <div className="mt-3">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Your Rating: {ratings[movie.imdbID] || 0}/10</p>
