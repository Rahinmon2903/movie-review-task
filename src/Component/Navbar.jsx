...
const Navbar = () => {
  const { search, setSearch, moviesData, setMovieData, favorites } = useContext(myContext);
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-6">
        ...
        <Link to="/" className="flex items-center gap-3">
          ...
          <div className="text-white">
            <h1 className="text-lg font-extrabold tracking-tight">Cine<span className="text-red-500">Verse</span></h1>
        ...
        <div className="flex-1 flex items-center gap-3">
          <div className="flex items-center flex-1 bg-[#0d0d0d] border border-black/40 rounded-xl px-3 py-2 shadow-[inset_0_2px_8px_rgba(0,0,0,0.6)]">
            <svg className="w-5 h-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-4.35-4.35M10.5 18a7.5 7.5 0 1 1 0-15 7.5 7.5 0 0 1 0 15z" /></svg>
            <input
              value={search}
